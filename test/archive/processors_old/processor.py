...
def _process_page_streams_with_docling(streams: List, complex_mode: bool) -> List:
...
def process_document_easy_mode(file_path: str) -> ProcessingResult:
...
def process_complex_pages(
    ...
    try:
        ...
        conv_results = _process_page_streams_with_docling(streams, complex_mode=True)
...
def process_non_pdf_document(file_path: str):
...
def process_document(file_path: str):
    ...
    try:
        ...
        if _is_pdf_file(file_path):
            ...
            result = process_non_pdf_document(file_path)
